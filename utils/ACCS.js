...
if (theHelp != undefined) {
	...
	console.log('  -o application_name : name of the application to delete, for example MyApp');
...
const baseUrl = 'https://apaas.europe.oraclecloud.com/paas/service/apaas/api/v1.1/apps/';
...
request(options, function(err, res, body) {  
	...
	if (res.statusCode === 200) {
		...
		for(var myKey in apps) {
			...
			console.log("     Name          : " + apps[myKey]['name']);
			console.log("     Created by    : " + apps[myKey]['createdBy']);
			console.log("     Creation date : " + apps[myKey]['creationTime']);
